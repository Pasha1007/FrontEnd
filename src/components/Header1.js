                  ...
                  <div class="col-lg-3 head" style={{width:"300px", paddingLeft:'140px'}}>
                    <div style={{width:"500px"}} id='headerblck' class="col-12 col-lg-6 col-xl-5 offset-xl-1">
                      <div class='butns'>
                        ...
                        <MDBBtn id="redbut" class="btn btn-light btn-lg action-button" type="button">Вхід</MDBBtn>
                       
                        <div>
                        <MDBBtn onClick={toggleShow}  id="redbut1" class="btn btn-light btn-lg action-button" type="button">Зареєструватися</MDBBtn>
